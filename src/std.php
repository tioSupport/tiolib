...
class std{
    ...
    public function checkSearch($var, $default = '') {
        $res = $default;
    ...
    public function send_email($toemail,$subject,$cosa,$fromEmail='',$priority=1) {
    ...
    public function send_sms($originator, $number, $text, $priority=1) {
    ...
    public function arrayOrderById($oldArr,$keyName='id') {
    ...
    public function ajaxEchojson($dati) {
    ...
    public function urlExists($file) {
    ...
    public function formatcurrency($num,$len=2,$round=false) {
        if ($round) {
    ...
    public function createsignature($hashstring='',$secretkey='ADBpfi52') {
    ...
    public function url_get_contents($Url,$dataPost=array()) {
      global $curl;
    ...
    public function timeAgo($time, $shorthand = true){
    ...
    public function save_to($url, $path){
        $ch = curl_init($url);
    ...
    public function cms_curl($json_data, $url, $timeout = 30000, $headers = null, $method = 'get'){
    ...
    public function json_post($json_data, $url, $timeout = 30000, $headers = null){
    ...
    public function std_page($max_items, $buttons = false, $items_count = -1){
        $out  = '';
        if ($buttons == false){
    ...
    public function std_box($title = '', $content = '',$class='' , $titleClass='', $boxClass=''){
    ...
    public function hash_color($seed, $lighten = 100){
    ...
    public function call_api($method, $url, $data = false , $timeout = 5000)
    {
        $curl = curl_init();
    ...
    public function std_error($content = '', $type = 'error'){
    ...
    public function hyperlink($text, $blank = false) {
    ...
    public function hypermail($text)
    {
        $regex = '/(\S+@\S+\.\S+)/';
    ...
    public function std_topline($color = '#214156'){
    ...
    public function std_interface($title, $content, $menu = '', $pre_menu = '', $post_menu = ''){
    ...
    public function input_colorbox($name, $val, $params = ''){
    ...
    public function input_date($name, $val, $format = 'ymd', $separator = '.', $params = ''){
    ...
    public function input_hour_sql($name, $val = '00:00:00', $min_divider = 1){
    ...
    public function input_datetime($name, $format = '', $default_time = '', $date_picker = true, $time_picker = true, $params = '', $rimuovi = false){
    ...
    public function input_datetime_sql($name, $val = '2000-01-01 00:00:00', $min_divider = 1, $hourtext = ' '){
    ...
    public function input_password($name, $val, $params = ''){
        return '<input type="password" name="'.$name.'" value="'.$val.'" '.$params.' />';
    }

    // Campo HTML Input Checkbox
    public function input_checkbox($name, $checked = false, $value = '', $params = ''){
    ...
    public function input_checkbool($name, $checked = false, $disabled = false, $params = '', $onclick = ''){
    ...
    public function input_select($name, $array_val, $current = '', $params = ''){
    ...
    // Campo HTML Textarea
    public function input_textarea($name, $val, $params = ''){
    ...
    public function input_richtextarea($name, $val, $params = '', $statusbar = false){
    ...
    $type:
        ...
        7 = video (.mp4)
    */
    public function input_file($name, $val, $type = 1, $params = ''){
        global $this_app;
    ...
    // Form tab standard
    public function std_tab_menu($tabs, $selected_id = '', $tools = '', $title = '', $click_callback = '', $styles = array()){
        $callback = '';
    ...
    // Tab standard
    public function std_tab($id, $content){
    ...
    public function std_edit_opentable($id = '', $add_form_data = '', $add_toolbar_item = '', $use_std_buttons = true, $action = "", $formparams = "", $overflow = false,$close=true){
        if($action === ""){
    ...
    public function std_edit_row($name, $data = '', $params = ''){
        if (!empty($data)){
    ...
    public function std_edit_closetable($add_toolbar_item = '', $overflow = false){
        $i = '</table>';
         if($overflow){
            $i.='</div>';
        }
    ...
    public function std_list_opentable($id, $field_names, $thead = true, $add_class="", $params = ''){
    ...
    public function std_list_row($id = '', $fields_data, $params = ''){
    ...
    public function get_unique_record($rs){
        if (sizeof($rs) == 1){
            return $rs[0];
        }
        return false;
    ...
    public function std_output_pdf($title, $item_name, $content, $drawlines = false){
    ...
    public function sql_auto_insert($sql_inst, $table, $key = 0, $redirect_url = '', $apicall = ''){
        global $config;
    ...
    public function lista_nazioni_ristrette(){
        return array("ch" => "Svizzera", "it" => "Italia");
    }

    public function lista_nazioni_eu(){
    ...
    public function nome_nazione($prefix){
    ...
    public function country_name($prefix){
    ...
    public function mssqlHumanDate($dd) {
        if ($dd>'') {
    ...
    public function mssqlLogicDate($dd) {
        if ($dd>'') {
            $dd = trim(substr($dd,0,11));
            $da = split('[-]',$dd);
    ...
    public function sqlTextDate($mysqldate, $show_time = false, $show_date = true, $forcefull = false){
    ...
    public function get_file_date($file_name){
    ...
    public function perms_info($fname){
    ...
    public function list_files($fold, $sort = false){
    ...
    public function pre($array, $float = false, $dump = false){
    ...
    public function header_current_date(){
    ...
    public function cut($str, $len, $cut_chars = '...', $exact = false){
        ...
        public function upload_error_codes($error_code){
            $codes = array(
        ...
        public function mmtostring($month, $short = false){
        ...
        public function ddtostring($day,$short=false, $spchars = false, $entities = false){
            if ($short) {
                switch ($day) {
        ...
        public function curl_post($data = '', $url, $timeout = 3000){
        ...
        public function httpPost($host, $port, $path, $data, $charset = 'UTF-8') {
        ...
        public function random_code($len, $readable = false){
        ...
        public function random_hash($extra_seed = ''){
        ...
        public function ftp_write($ftp_server, $ftp_username, $ftp_pass, $ftp_filepath, $ftp_filecontent){
        ...
        public function ftp_put_file_new($xfile,$xpath,$ftp_server,$ftp_user_name,$ftp_user_pass)
        {
            $result = true;
            $protocol_ftp = '';
        ...
        public function array_found($wh,$array) {
      ...
      public function dir_list($dir,$ext='')
      {
    ...
    public function wd_resize($source,$dest,$new_width,$new_quality) {
    ...
    public function imagecreatefrom_any($img){
    ...
    public function resize_max($inputfile, $outputfile, $max_size, $quality = 100){
    ...
    public function img_watermark($inputfile, $outputfile, $watermark_image){
    ...
    public function resize_to_canvas($filename, $dest_filename,$canvas_w=100,$canvas_h=225, $bgcolor = '#000000', $quality = 100, $text = ''){
    ...
    public function crop($inputfile, $outputfile, $x, $y, $w, $h, $resize_to_w = 0, $resize_to_h = 0){
    ...
    public function crop_resize($filename, $width, $height, $outputfile, $quality, $text = ''){
    ...
    public function delcontent_dir($xdir) {
        if (is_dir($xdir)) {
            $xreturn = true;
            $d = dir($xdir);
            while($entry = $d->read()) {
    ...
    public function _utf8_to_html ($data) {
        $ret = 0;
    ...
    public function clean_url($str, $spaces = false, $entities = true){
    ...
    public function remove_accents($str, $enc = "UTF-8"){
    ...
    public function GetFolderSize($d =".", $human = false) {
    ...
    public function getNltkWords($string){
            $nltk = [];
    ...
    public function sitelink($type, $data){
    ...
    public function json_section_list($id_domain){
    ...
    public function clean_site_url($url,$nodashes = false){
    ...
    public function get_section_by_id($id, $id_domain){
        global $sqlPDO;
    ...
    public function getSocialTexts($id_content, $maxTextLength = 0){
    ...
    public function getFullLink($id, $mobile = false){
        global $sqlPDO, $config;
    ...
    public function cleanHashtag($string){
    ...
    public function clean_url_web($url,$nodashes = false){
    ...
    public function object_url($object,$prefix = ''){
    ...
    public function get_content_diff($content_from, $content_to){
    ...
    public function clean_version_string($string){
    ...
    public function percentage_to_rgb($i) {
        // as the public function expects a value between 0 and 1, and red = 0° and green = 120°
